        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ContentName = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DOB = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SubmissionMedias", x => new { x.MediaId, x.SubmissionId });
                    table.ForeignKey(
                        name: "FK_SubmissionMedias_Medias_MediaId",
                        column: x => x.MediaId,
                        principalTable: "Medias",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SubmissionMedias_Submissions_SubmissionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SubmissionMedias_SubmissionId",
                table: "SubmissionMedias",
                column: "SubmissionId");
